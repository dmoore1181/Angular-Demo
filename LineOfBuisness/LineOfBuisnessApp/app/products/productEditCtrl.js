(function() {
    ...
    angular.module('productManagement').controller('ProductEditCtrl', ['product', '$state', 'productService', ProductEditCtrl]);
    ...
    function ProductEditCtrl(product, $state, productService) {
        ...
        vm.calculatePrice = function() {
            ...
            if (vm.priceOption === 'amount') {
                price = productService.calcualtePriceFromMarkupAmount(vm.product.cost, vm.markupAmount);
            }
