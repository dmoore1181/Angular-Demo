...
HttpServer.prototype.start = function (port) {
    ...
    console.log('**WARNING** This exposes an unsecure webserver on port ' + port + '!');
    console.log('**WARNING** While this server is running it will allow anyone with ');
    console.log('**WARNING** access to port ' + port + ' to write to your filesystem!');
    console.log('**WARNING** While some care has been taken to prevent access outside of the ');
    console.log('**WARNING** test app area, precautions should be taken to prevent');
    console.log('**WARNING** external access to this port.');
